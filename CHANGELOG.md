...
- add seo metadata for game page

### Fixed

- address style review comments
- restrict pages deploy permissions
- refine score lcd spacing

### Other

- *(pause)* move pause handling into Game ([#22](https://github.com/NLipatov/snake/pull/22))
...
- tune mobile controls and browser icon

### Fixed

- match terminal input semantics in web
- queue web direction input by tick
